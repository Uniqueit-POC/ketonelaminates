...
<footer id='footer' class='footer'>
      ...
      <div class='row'>
        ...
        <div class='col-lg-4 col-md-6'>
          <div class='footer-info'>
            <h3><a href='index.php' > Ketone Laminates </a></h3>
            <p>
        ...
        <div class='col-lg-2 col-md-3 footer-links'>
          <h4>Our Catelogs</h4>
          <ul>
          <li><a href='kiwi-decor.php'>Kiwi Decor </a></li>
          <li><a href='ripple.php'>Ripple </a></li>
          <li><a href='Plain Color.php'>Plain Color</a></li>
          </ul>
        </div><!-- End footer links column-->

        <div class='col-lg-4 col-md-6 footer-links'>
        <img class='img-fluid' alt='Make In India' src='assets/img/Make-in-ndia-Logo-PNG-HD-Transparent.png' />
        </div><!-- End footer links column-->
  ...
  <div class='footer-legal text-center position-relative'>
    <div class='container'>
      <div class='copyright'>
        &copy; Copyright <strong><span><a href='index.php' >Ketone Laminates</a></span></strong>. All Rights Reserved
      </div>
      <div class='credits'>
        Developed by<a> Unique It Solution</a>
      </div>
    </div>
  </div>
